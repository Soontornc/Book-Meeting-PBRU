            ...
            try {
                ...
                listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        intent.putExtra("NameBuild", nameBuildStrings[position]);
                        intent.putExtra("NameRoom", nameRoomStrings[position]);
                        intent.putExtra("Size", sizeStrings[position]);
                        intent.putExtra("PriceDay", priceDayStrings[position]);
                        intent.putExtra("PriceHoliday", priceHoliStrings[position]);
                        intent.putExtra("Image1", iconStrings[position]);
                        ...
                        intent.putExtra("Image5", image5Strings[position]);
