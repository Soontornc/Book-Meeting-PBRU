...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        nameBuildTextView.setText("อาคาร "+nameBuildStrings[i]);
        ...
        priceDayTextView.setText("ราคาปกติ "+priceDayStrings[i]+" บาท");

        TextView priceHoliTextView = (TextView) view1.findViewById(R.id.textView12);
        priceHoliTextView.setText("ราคาวันหยุด "+priceHolidayStrings[i]+" บาท");
