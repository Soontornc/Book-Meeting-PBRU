...
public class CalendarActivity extends AppCompatActivity {
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i=0;i<jsonArray.length();i++) {
                    ...
                    MyManage myManage = new MyManage(CalendarActivity.this);
    ...
    private void alertErrorDay() {
        ...
        myAlert.myDialog(CalendarActivity.this, "ห้ามย้อนเวลา", "เลือกวันใหม่");
    }
    ...
    public void clickOrderCalendar(View view) {
        ...
        if (checkRadioButton()) {
            ...
            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this, "ห้องไม่ว่าง","กรุณาเลือกใหม่");
        } else {
            updateToServer();
        }
    ...
    private boolean checkRoom() {
        ...
        try {
            ...
            Log.d("26MayV1", "dataString => " + dateString);
